'''
This program is run local in Udacity Project workspace
...
def write_parquet_files(spark, song_df, log_df, songs_table, artists_table, users_table, time_table, songplays_table, user_listen, output_path):    
    """
    Summary line. 
...
def main():
    ...
    write_parquet_files(spark, song_df, log_df, songs_table, artists_table, users_table, time_table, songplays_table, user_listen, output_path)
