...
def main():
    ...
    sampleDbBucket =  s3r.Bucket("udacity-dend")
    
    print('Downloading song_data')
    download_files_from_s3(sampleDbBucket, './data/song_data', 20000)
    
    print('Downloading log_data')
    download_files_from_s3(sampleDbBucket, './data/log_data', 20000)
